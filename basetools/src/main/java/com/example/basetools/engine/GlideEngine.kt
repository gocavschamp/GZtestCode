 ...
 */
class GlideEngine constructor() : ImageEngine {
    /**
     * 加载图片到ImageView
     *
     * @param context   上下文
    ...
    public override fun loadPhoto(context: Context, uri: Uri, imageView: ImageView) {
     ...
     */
    //安卓10推荐uri，并且path的方式不再可用
    public override fun loadGifAsBitmap(context: Context, gifUri: Uri, imageView: ImageView) {
     ...
     */
    //安卓10推荐uri，并且path的方式不再可用
    public override fun loadGif(context: Context, gifUri: Uri, imageView: ImageView) {
    ...
    public override fun getCacheBitmap(
        context: Context,
        uri: Uri,
        width: Int,
        height: Int
