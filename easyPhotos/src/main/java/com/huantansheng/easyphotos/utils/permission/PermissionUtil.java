...
public class PermissionUtil {
    ...
    public static boolean checkPermissionsInActivity(Activity cxt,
                                                               String checkPermissions) {
        return PermissionChecker.checkSelfPermission(cxt, checkPermissions) == PermissionChecker.PERMISSION_GRANTED;
    }
